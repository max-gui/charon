...
require (
	...
	github.com/max-gui/consulagent v0.0.0-20230419062459-c27815ae7f16
	github.com/max-gui/logagent v0.0.0-20221026074548-3d072821cb1d
	github.com/max-gui/regagent v0.0.0-20220927095053-e3073cf44b57
